...
public class upload_notice extends AppCompatActivity {
    ...
    private void Uploadimage() {
        ...
        uploadt.addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
            @Override
    ...
    {
        drf = drf.child("Notice");
        final String uniqukey = drf.push().getKey();
        ...
        drf.child(uniqukey).setValue(ndata).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
